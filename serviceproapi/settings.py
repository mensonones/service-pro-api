"""
Django settings for serviceproapi project.
...
SECRET_KEY = 'django-insecure-qd(4pkj9@m=tbzu(b*ak7p3-(9ma+q$_9--ct*s!(x%vsegu0c'
...
ROOT_URLCONF = 'serviceproapi.urls'
...
WSGI_APPLICATION = 'serviceproapi.wsgi.application'
